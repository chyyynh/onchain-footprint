...
// Database operations - Functional Programming approach
export const upsertTrackedWallet = async (address: string, label?: string): Promise<TrackedWallet | null> => {
...
export const insertTransactions = async (transactions: Omit<Transaction, 'id' | 'created_at' | 'updated_at'>[]): Promise<boolean> => {
...
export const insertTransactionLogs = async (logs: Omit<TransactionLog, 'id' | 'created_at'>[]): Promise<boolean> => {
  const { error } = await supabaseAdmin
...
export const insertAssetTransfers = async (transfers: Omit<AssetTransfer, 'id' | 'created_at'>[]): Promise<boolean> => {
...
export const getWalletStats = async (walletAddress: string): Promise<any> => {
...
export const updateWalletSyncStatus = async (
  address: string, 
...
export const getTransactionCount = async (walletAddress: string): Promise<number> => {
